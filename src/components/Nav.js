            ...
            <div className='nav-ui'>
                ...
                <div className={display ? 'display' : 'noDisplay'}>
                    <div className='dropdown-ui'>
                        <Link onClick={() => handleDisplay()} className='ui-items' style={{ textDecoration: 'none', color: 'white' }} to='/dadjokes'>Favorite Jokes</Link>
                        <Link onClick={() => handleDisplay()} className='ui-items' style={{ textDecoration: 'none', color: 'white' }} to='/weather'>Weather</Link>
                        <Link onClick={() => handleDisplay()} className='ui-items' style={{ textDecoration: 'none', color: 'white' }} to='/settings'>Settings</Link>
                    </div>
